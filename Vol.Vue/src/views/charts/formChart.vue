  ...
  <div class="c-container">
    <div class="item">
      <div style="height:300px;" class="left">
        <VolHeader icon="md-apps" text="柱状图" style="margin-bottom: 5px;"></VolHeader>
    ...
    <div class="item">
      <div style="height:290px;" class="left">
        <VolHeader icon="md-apps" text="表单属性字段只读" style="margin-bottom: 20px;"></VolHeader>
        <VolForm
      ...
      <div style="height:290px;" class="right">
        <VolHeader icon="md-apps" text="饼状图表" style="margin-bottom: 5px;"></VolHeader>
