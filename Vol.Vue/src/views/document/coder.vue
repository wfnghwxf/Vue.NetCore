<template>
  <div id="cnblogs_post_body">
    ...
    <p></p>
       <a style="color:red;" href="#param">在代码生成页面,不需要写代码,按照代码生成配置的属性即可完成：查询、删除、新增、修改、导入、导出、审核、select及多选框的数据源自动绑定等功能</a>
    <p></p>
 <p></p>
        ...
        <tr>
          ...
          <td>
            ...
            <span>列(此配置直接决定表的编辑或新建字段,不在此配置中的字段，编辑或新建时都会被过滤移除)</span>
              <span style="color:red;">编辑行修改后需要点击【生成model】,如果只想编辑，界面不想显示，编辑行设置为0</span>
          </td>
        </tr>
        <tr>
          <td>
